...
public class Cluster {
    ...
    //added by liumi
    public static final String RUNTIMETRAFFIC_ROOT = "traffic";
    public static final String RUNTIMELOAD_ROOT = "traffic";
    ...
    public static final String RUNTIMETRAFFIC_SUBTREE;
    public static final String RUNTIMELOAD_SUBTREE;
    ...
    static {
        ...
        RUNTIMETRAFFIC_SUBTREE = ZK_SEPERATOR + RUNTIMETRAFFIC_ROOT;
        RUNTIMELOAD_SUBTREE = ZK_SEPERATOR + RUNTIMELOAD_ROOT;

    }

    //added by liumi
    public static String runtimeTraffic_path(String id) {
        return RUNTIMETRAFFIC_SUBTREE + ZK_SEPERATOR + id;
    }
    public static String runtimeLoad_path(String id) {
        return RUNTIMELOAD_SUBTREE + ZK_SEPERATOR + id;
    }
