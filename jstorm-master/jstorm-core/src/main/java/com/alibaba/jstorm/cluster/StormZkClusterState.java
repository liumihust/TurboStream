...
public class StormZkClusterState implements StormClusterState {
    ...
    //added by liumi
    private ConcurrentHashMap<String, RunnableCallback> worker_traffic_callback;
    private ConcurrentHashMap<String, RunnableCallback> worker_load_callback;
    ...
    public StormZkClusterState(Object cluster_state_spec) throws Exception {
        ...
        //aded by liumi
        worker_traffic_callback = new ConcurrentHashMap<String, RunnableCallback>();
        worker_load_callback = new ConcurrentHashMap<String, RunnableCallback>();
    ...
    //added by liumi
    public HashMap<Integer,HashMap<Integer,Integer>> getRuntimeTraffic(String workerid, RunnableCallback callback)
            throws Exception {
        String path = Cluster.runtimeTraffic_path(workerid);
        worker_traffic_callback.put(workerid,callback);

        return (HashMap<Integer, HashMap<Integer,Integer>>) getObject(path,callback != null);

    }
    public void setRuntimeTraffic(String workerid,HashMap<Integer,HashMap<Integer,Integer>> traffic)
            throws Exception {
        setObject(Cluster.runtimeTraffic_path(workerid),traffic);

    }

    public HashMap<Integer,Integer> getRuntimeLoad(String workerid, RunnableCallback callback)
            throws Exception {
        String path = Cluster.runtimeLoad_path(workerid);
        worker_load_callback.put(workerid,callback);

        return (HashMap<Integer,Integer>) getObject(path,callback != null);

    }
    public void setRuntimeLoad(String workerid,HashMap<Integer,Integer> load)
            throws Exception {
        setObject(Cluster.runtimeLoad_path(workerid),load);
